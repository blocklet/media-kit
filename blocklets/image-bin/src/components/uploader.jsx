...
function UploaderProviderWrapper({ children }) {
  ...
  return (
    <UploaderProvider
      ...
      //       id: 'Safari',
      //       title: 'Safari',
      //       icon: `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="194.5 190.1 135.1 135.1">
      //         <style>
      //             .b {
      ...
      //                 </feMerge>
      //             </filter>
      //             <radialGradient id="i" cx="-69.88" cy="69.29" r="54.01" gradientTransform="matrix(.9023 -.01249 .0377 2.7234 -9.44 -120.29)" xlink:href="#b">
      //                 <stop offset="0" stop-color="#24a5f3" stop-opacity=".01"/>
      //                 <stop offset="1" stop-color="#1e8ceb" stop-opacity=".98"/>
      //             </radialGradient>
      //             <radialGradient id="j" cx="109.35" cy="13.76" r="93.08" gradientTransform="matrix(-.01822 1.0922 -1.042 -.01765 136.95 -115.33)" xlink:href="#b">
      //                 <stop offset="0" stop-opacity="0"/>
      //                 <stop offset=".96" stop-color="#5488d6" stop-opacity="0"/>
      //                 <stop offset="1" stop-color="#5d96eb"/>
      //             </radialGradient>
      //         </defs>
      //         <rect width="220" height="220" x="22" y="-106.53" fill="url(#a)" filter="url(#e)" ry="49" transform="matrix(.56938 0 0 .56921 186.86 255.75)"/>
      ...
      //         <g filter="url(#g)" transform="matrix(.58289 0 0 .56508 196.8 181.63)">
